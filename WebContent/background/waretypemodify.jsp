  ...
  <body>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm" method="post" action="${pageContext.request.contextPath }/warehouseTypeAction/updataWaretsave.action">
                            <div class="form-group">
                                <label class="col-sm-3 control-label" id="warename">仓库类型名称：</label>
                                <div class="col-sm-5">
                                    <input name="warehouseId" value="${ware.warehouseId}" class="form-control" type="hidden">
                                    <input id="wareNameHidden" name="warehouseNameHidd" value="${ware.warehouseName}" class="form-control" type="hidden">
                                    <input id="warehouseName" name="warehouseName" value="${ware.warehouseName}" class="form-control" type="text">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-8 col-sm-offset-4">
                                    <button class="btn btn-primary" id="addWaremodify" type="button">提交</button>
                                    <a>
    ...
    <script type="text/javascript">
       $(function(){
    	   ...
    	   $("#addWaremodify").on("click",function(){
    		   var wareNameHidden =$("#wareNameHidden").val();
    		   ...
    		   if(warehouseName == null || warehouseName == "" || $.trim(warehouseName) == ""){
        		   ...
        		   if(wareNameHidden==warehouseName)
        			   $("#signupForm").submit();
        		   else
        		   $.ajax({//异步查询是否存在同一个仓库名
        			   type:"GET",
