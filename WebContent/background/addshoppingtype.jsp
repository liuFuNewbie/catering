...
<html>
  ...
  <body>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="navForm" action="${pageContext.request.contextPath }/navigation/addNavigation.action" method="post">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">商品类别名称：</label>
                                <div class="col-sm-5">
                                    <input id="navName" name="navName" class="form-control" type="text">                                
                                </div>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/js/background/addshoppingtype.js"></script>
