			...
			<div class="container">
				<div class="row">
					...
					<span class="increasedHead">
					  <a href="${pageContext.request.contextPath }/background/materialadd.jsp">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 purchaseInfo">
						<table border="1">
							...
							<tr>
								...
								<td>52</td>
								<td>
									<a href="${pageContext.request.contextPath }/background/materialmodify.jsp"><img title="修改" src="${pageContext.request.contextPath }/img/xiugai.png"/></a>&nbsp;&nbsp;&nbsp;
