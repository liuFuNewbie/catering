...
<body>
							...
							<div class="form-groupe">
								...
								<div class="col-sm-3" style="display: none">
									<input id="supplierId" name="supplierId" class="form-control"
										type="text" value="${supplier.supplierId }"> <span
								...
								<div class="col-sm-3">
									<input id="supplierName" name="supplierName"
										...
										value="${supplier.supplierName }"> <span
										class="help-block m-b-none"></span>
								</div>
								<label class="col-sm-2 control-label">电话号码：</label>
								<div class="col-sm-4">
									<input id="phone" name="phone" class="form-control" type="text"
										value="${supplier.phone }"> <span
										class="help-block m-b-none"></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input id="shoppingName" name="shoppingName"
										class="form-control" type="text"
										value="${supplier.shoppingName }"> <span
										class="help-block m-b-none"></span>
								</div>
								<label class="col-sm-2 control-label">家庭地址：</label>
								<div class="col-sm-4">
									<input id="address" name="address" class="form-control"
										type="text" value="${supplier.address }"> <span
										class="help-block m-b-none"></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input id="remark" name="remark" class="form-control"
										type="text" value="${supplier.remark }"> <span
										class="help-block m-b-none"></span>
								</div>
							</div>
							<div class="form-group">
	...
	<script type="text/javascript">
			...
			$("#btn_suppliermodify").on(
					...
					function() {
						...
						if (!checkForm(arr)) {
							...
							checkSupplier(supplierId, supplierName,
									shoppingName, phone, address, remark);
						}
					});
		});
		...
		function checkSupplier(supplierId, supplierName, shoppingName, phone,
				address, remark) {
			$
					.ajax({
						url : "${pageContext.request.contextPath}/background/updateSupplierById.action",
						data : {
