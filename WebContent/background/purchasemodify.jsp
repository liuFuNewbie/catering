                ...
                <div class="ibox float-e-margins">
                    ...
                    <br/>
                     <div class="ibox-content">
                         <form class="form-horizontal m-t" id="signupForm" method="post" action="${pageContext.request.contextPath }/purchaseAction/updataPursave.action">
                            <input id="purchaseId" name="purchaseId" value="${purchase.purchaseId }" type="hidden"/>
                            <div class="form-groupe">
                                <label class="col-sm-2 control-label">商品名称：</label>
                                <div class="col-sm-3">
                                    <input id="shoppingName" name="shoppingName" class="form-control" type="text" value="${purchase.shoppingName }" >
                                    <span class="help-block m-b-none"></span>
                                </div>
                                <label class="col-sm-2 control-label">数量：</label>
                                <div class="col-sm-4">
                                    <input id="number" name="number" class="form-control" type="text" value="${purchase.number }">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                     <input id="unit" name="unit" class="form-control" type="text" value="${purchase.unit }">
                                     <span class="help-block m-b-none"></span>
                                </div>
                                <label class="col-sm-2 control-label">金额：</label>
                                <div class="col-sm-4">
                                    <input id="money" name="money" class="form-control" type="text" value="${purchase.money }">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-8 col-sm-offset-4">
                                    ...
                                    <button class="btn btn-primary" type="button" id="modifyAdd">提交</button>
                                    <a>
