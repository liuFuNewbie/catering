 		...
 		<div class="page-bar">
			<ul class="page-num-ul clearfix">
				...
				<c:if test="${param.currentPageNo < param.totalPageCount }">
					...
					<li><a href="javascript:page_nav(document.forms[0],${param.totalPageCount });">最后一页</a></li>
				</c:if>
				<li>&nbsp;&nbsp;
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/combopage.js"></script>
</html>