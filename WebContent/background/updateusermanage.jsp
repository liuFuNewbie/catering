				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal m-t" id="signupForm"
							action="${pageContext.request.contextPath }/userAction/updateUserById.action"
							enctype="multipart/form-data" method="post">
							<div class="form-groupe" style="display: none;">
							...
							<div class="form-groupe">
								...
								<div class="col-sm-3">
									<input id="userName" name="userName" class="form-control"
										type="text" value="${user.userName }"> <span
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input id="userPwd" name="userPwd" class="form-control"
										type="text" value="${user.userPwd }"> <span
										class="help-block m-b-none"></span>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input id="birthdates" name="birth" class="form-control"
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<select id="roleId" name="roleId" class="form-control">
										...
										<c:forEach var="role" items="${getRoleList }" varStatus="i">
											<option value="${role.roleId }"
												<c:if test="${role.roleId==user.roleId }">selected="selected"</c:if>>${role.roleName }</option>
										</c:forEach>
									</select>
								</div>
								...
								<div class="col-sm-4">
									<input id="headPortraits" name="portraits" class="form-control"
										value="${user.headPortraits }" type="file"  onchange="filesize(this)"
										accept="*.webp,*.bmp,*.jpg,*.png,*.tiff,*.gif"> <span
										class="help-block m-b-none"></span>
								</div>
							</div>
							<div class="form-group">
