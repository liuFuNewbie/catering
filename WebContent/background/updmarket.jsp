            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                   ...
                   <div class="ibox-content">
                        <form action="${pageContext.request.contextPath }/markets/getUpdateMarket.action" method="post" class="form-horizontal m-t" id="signupForm">
                          <c:forEach items="${marketBylist }" var="ByList">
                          <input type="hidden" value="${ByList.marketId }" name="marketId">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input id="number" name="number" class="form-control" type="text" value="${ByList.number }">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">单价：</label>
                                <div class="col-sm-3">
                                    <input id="unitPrice" name="unitPrice" value="${ByList.unitPrice }" class="form-control" type="text">
                                </div>
                                <label class="col-sm-2 control-label">成本：</label>
                                <div class="col-sm-4">
                                    <input id="cost" name="cost" value="${ByList.cost }" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                            	<label class="col-sm-2 control-label">餐桌号：</label>
                                <div class="col-sm-3">
                                    <input id="tableNo" name="tableNo" value="${ByList.tableNo }" class="form-control" type="text" >
                                </div>
